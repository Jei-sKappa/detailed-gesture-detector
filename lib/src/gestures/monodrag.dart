// -----------------------------------------------------------------------------
// Forked from Flutter's original 'src/gestures/monodrag.dart' file.
// -----------------------------------------------------------------------------
...
/// {@endtemplate}
///
/// Used by [DetailedDragGestureRecognizer.onEnd].
typedef DetailedGestureDragEndCallback = void Function(DragEndDetails details, PointerEvent event);

/// Signature for when the pointer that previously triggered a
/// [GestureDragDownCallback] did not complete.
///
/// Used by [DetailedDragGestureRecognizer.onCancel].
typedef DetailedGestureDragCancelCallback = void Function(PointerEvent initialEvent, PointerEvent finalEvent);

/// Recognizes movement.
///
/// In contrast to [MultiDetailedDragGestureRecognizer], [DetailedDragGestureRecognizer]
...
///
/// [DetailedDragGestureRecognizer] is not intended to be used directly. Instead,
/// consider using one of its subclasses to recognize specific types for drag
/// gestures.
///
/// [DetailedDragGestureRecognizer] competes on pointer events only when it has at
/// least one non-null callback. If it has no callbacks, it is a no-op.
///
/// See also:
///
///  * [DetailedHorizontalDragGestureRecognizer], for left and right drags.
///  * [DetailedVerticalDragGestureRecognizer], for up and down drags.
///  * [DetailedPanGestureRecognizer], for drags that are not locked to a single axis.
abstract class DetailedDragGestureRecognizer extends OneSequenceGestureRecognizer {
  /// Initialize the object.
  ///
  /// {@macro flutter.gestures.GestureRecognizer.supportedDevices}
  DetailedDragGestureRecognizer({
    super.debugOwner,
  ...
  /// ## Example:
  ///
  /// A [DetailedHorizontalDragGestureRecognizer] and a [DetailedVerticalDragGestureRecognizer]
  ...
  /// the [DetailedHorizontalDragGestureRecognizer] wins the arena. With
  ...
  /// {@template flutter.gestures.monodrag.DetailedDragGestureRecognizer.multitouchDragStrategy}
  ...
  DetailedGestureDragDownCallback? onDown;

  /// {@template flutter.gestures.monodrag.DetailedDragGestureRecognizer.onStart}
  ...
  DetailedGestureDragStartCallback? onStart;

  /// {@template flutter.gestures.monodrag.DetailedDragGestureRecognizer.onUpdate}
  ...
  /// [DetailedVerticalDragGestureRecognizer] or [DetailedHorizontalDragGestureRecognizer]),
  ...
  /// (a [DetailedPanGestureRecognizer]), then `details` will reflect movement on
  ...
  DetailedGestureDragUpdateCallback? onUpdate;

  /// {@template flutter.gestures.monodrag.DetailedDragGestureRecognizer.onEnd}
  ...
  DetailedGestureDragEndCallback? onEnd;
  ...
  ///
  ///  * [allowedButtonsFilter], which decides which button will be allowed.
  DetailedGestureDragCancelCallback? onCancel;
  ...
  /// [DetailedVerticalDragGestureRecognizer], x-axis for the [DetailedHorizontalDragGestureRecognizer],
  /// and the entire plane for [DetailedPanGestureRecognizer]. The threshold for both
  /// [DetailedVerticalDragGestureRecognizer] and [DetailedHorizontalDragGestureRecognizer] are
  /// calculated by [computeHitSlop], while [computePanSlop] is used for
  /// [DetailedPanGestureRecognizer].
  ///
  ...
  ///
  /// To estimate the velocity of a gesture, [DetailedDragGestureRecognizer] calls
  ...
  late PointerEvent _initialEvent;
  late OffsetPair _initialPosition;
  PointerEvent? _pendingDragEvent;
  late OffsetPair _pendingDragOffset;
  late PointerEvent _finalEvent;
  ...
  ///
  /// The [DetailedPanGestureRecognizer] returns null.
  ...
  void _checkDown() {
    if (onDown != null) {
      ...
      invokeCallback<void>('onDown', () => onDown!(details, _initialEvent));
    }
  }
  ...
  void _checkDrag(int pointer) {
    ...
    final PointerEvent? dragEvent = _pendingDragEvent;
  ...
  void _checkStart(Duration? timestamp, int pointer) {
    if (onStart != null) {
      ...
      invokeCallback<void>('onStart', () => onStart!(details, _initialEvent));
    }
  }
  ...
  void _checkUpdate({
    ...
    if (onUpdate != null) {
      ...
      invokeCallback<void>('onUpdate', () => onUpdate!(details, _initialEvent, event));
    }
  }
  ...
  void _checkEnd(int pointer) {
    ...
    invokeCallback<void>('onEnd', () => onEnd!(details!, _finalEvent), debugReport: debugReport);
  }

  void _checkCancel() {
    if (onCancel != null) {
      invokeCallback<void>('onCancel', () => onCancel!(_initialEvent, _finalEvent));
    }
  }
...
/// See also:
///
///  * [DetailedHorizontalDragGestureRecognizer], for a similar recognizer but for
///    horizontal movement.
///  * [MultiDetailedDragGestureRecognizer], for a family of gesture recognizers that
///    track each touch point independently.
class DetailedVerticalDragGestureRecognizer extends DetailedDragGestureRecognizer {
  /// Create a gesture recognizer for interactions in the vertical axis.
  ///
  /// {@macro flutter.gestures.GestureRecognizer.supportedDevices}
  DetailedVerticalDragGestureRecognizer({
    super.debugOwner,
    super.supportedDevices,
...
/// See also:
///
///  * [DetailedVerticalDragGestureRecognizer], for a similar recognizer but for
///    vertical movement.
///  * [MultiDetailedDragGestureRecognizer], for a family of gesture recognizers that
///    track each touch point independently.
class DetailedHorizontalDragGestureRecognizer extends DetailedDragGestureRecognizer {
  /// Create a gesture recognizer for interactions in the horizontal axis.
  ///
  /// {@macro flutter.gestures.GestureRecognizer.supportedDevices}
  DetailedHorizontalDragGestureRecognizer({
    super.debugOwner,
    super.supportedDevices,
    super.allowedButtonsFilter,
  });
...
/// See also:
///
///  * [ImmediateMultiDetailedDragGestureRecognizer], for a similar recognizer that
///    tracks each touch point independently.
///  * [DelayedMultiDetailedDragGestureRecognizer], for a similar recognizer that
///    tracks each touch point independently, but that doesn't start until
///    some time has passed.
class DetailedPanGestureRecognizer extends DetailedDragGestureRecognizer {
