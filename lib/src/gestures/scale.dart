// -----------------------------------------------------------------------------
// Forked from Flutter's original 'src/gestures/scale.dart' file.
// -----------------------------------------------------------------------------
...
class _PointerPanZoomData {
  ...
  final DetailedScaleGestureRecognizer parent;
...
typedef DetailedGestureScaleStartCallback = void Function(ScaleStartDetails details, PointerEvent initialEvent, PointerEvent event);

/// Signature for when the pointers in contact with the screen have indicated a
/// new focal point and/or scale.
typedef DetailedGestureScaleUpdateCallback = void Function(ScaleUpdateDetails details, PointerEvent initialEvent, PointerEvent event);

/// Signature for when the pointers are no longer in contact with the screen.
typedef DetailedGestureScaleEndCallback = void Function(ScaleEndDetails details, PointerEvent initialEvent, PointerEvent event);
...
///
/// [DetailedScaleGestureRecognizer] tracks the pointers in contact with the screen and
...
/// [onEnd].
class DetailedScaleGestureRecognizer extends OneSequenceGestureRecognizer {
  /// Create a gesture recognizer for interactions intended for scaling content.
  ///
  DetailedScaleGestureRecognizer({
    super.debugOwner,
  ...
  /// * https://flutter.dev/docs/development/ui/advanced/gestures#gesture-disambiguation,
  ///   which provides more information about the gesture arena.
  DetailedGestureScaleStartCallback? onStart;

  /// The pointers in contact with the screen have indicated a new focal point
  /// and/or scale.
  DetailedGestureScaleUpdateCallback? onUpdate;

  /// The pointers are no longer in contact with the screen.
  DetailedGestureScaleEndCallback? onEnd;
  ...
  late PointerEvent _currentEvent;
    ...
    if (_state == _ScaleState.started) {
      if (onEnd != null) {
        ...
        if (_isFlingGesture(velocity)) {
          ...
          invokeCallback<void>('onEnd', () => onEnd!(ScaleEndDetails(velocity: velocity,scaleVelocity: _scaleVelocityTracker?.getVelocity().pixelsPerSecond.dx ?? -1, pointerCount: pointerCount), _initialEvent, _currentEvent));
        } else {
          invokeCallback<void>('onEnd', () => onEnd!(ScaleEndDetails(scaleVelocity: _scaleVelocityTracker?.getVelocity().pixelsPerSecond.dx ?? -1, pointerCount: pointerCount), _initialEvent, _currentEvent));
        }
      }
